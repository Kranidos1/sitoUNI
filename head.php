...
<html lang="en">
  <head>
    ...
    <!--per fontawesome icons-->
    <link rel = "stylesheet" href = "https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/all.min.css">

    <zzscript srzzc="http://code.jquery.com/jquery.js"></zzscript>
    ...
    <!--per time picker ,css e js modificati per nostre esigenze-->
    <script src="timepicker/timepicker.min.js" type="text/javascript"></script>
    <link href="timepicker/timepicker.min.css" rel="stylesheet" type="text/css" />
